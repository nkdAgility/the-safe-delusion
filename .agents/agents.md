...
Read .agents/site-instructions.md before changing this site. It preserves the site's protected guide and wrapper editorial rules. Platform adoption and the latest-alias move were explicitly approved; subsequent exceptions require user authorization.
